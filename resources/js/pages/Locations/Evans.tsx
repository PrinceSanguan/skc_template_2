...
import { MapPin, Phone, Mail, Clock, Star, Users, Award, Calendar, ArrowRight } from "lucide-react"
...
export default function Evans() {
  ...
  const [activeTab, setActiveTab] = useState<"facility" | "reviews">("facility")
  ...
  const handleImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
    ...
    img.src = "/serene-dojo.png" // Fallback to placeholder
  }
  ...
  return (
    <Template title="Evans Location">
            ...
            <div className="w-full md:w-1/2 md:pr-8">
              <AnimatedElement type="fadeIn" delay={0.2}>
                <div className="inline-flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-red-400 uppercase tracking-wider text-xs font-semibold">Our Locations</span>
                </div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-red-200">
                  <span className="text-red-600">Evans</span>, GA Dojo
                </h1>
            ...
            <div className="w-full md:w-1/2 mt-6 md:mt-0">
              <AnimatedElement type="fadeIn" delay={0.4}>
                <div className="relative h-48 md:h-64 overflow-hidden rounded-lg">
                  ...
                  <img
                    src={selectedImage || "/placeholder.svg?height=400&width=600&query=martial arts dojo"}
                    alt="Evans Dojo"
      ...
      <section className="py-6 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex border-b border-red-900/20 mb-6">
            ...
            <button
              className={`px-4 py-2 text-sm font-medium ${
                activeTab === "reviews" ? "text-red-500 border-b-2 border-red-500" : "text-gray-400 hover:text-gray-300"
              }`}
          ...
          {activeTab === "facility" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Facility Gallery */}
              <div className="rounded-lg border border-red-900/30 bg-black/60 shadow-md backdrop-blur-sm overflow-hidden hover:border-red-600/50 transition-all duration-300">
                  ...
                  <div className="h-64 bg-black/40 flex items-center justify-center relative overflow-hidden">
                    {selectedImage ? (
                      ...
                      <div className="flex items-center justify-center h-full w-full">
                        <span className="text-sm text-gray-400 relative z-10">Loading Facility Images...</span>
                      </div>
                    )}
                  </div>
                </div>
                <div className="p-4">
                  <h3 className="text-sm font-bold text-white mb-2">Our Training Facility</h3>
                  <div className="h-0.5 w-8 bg-gradient-to-r from-red-600 to-red-400 rounded-full mb-3"></div>
                  <p className="text-xs text-gray-300 mb-4">
                    Our state-of-the-art facility features padded training areas, specialized equipment, changing rooms,
                    a viewing area for parents, and a pro shop with quality martial arts supplies.
                  </p>
                  <div className="grid grid-cols-4 gap-2">
                    {facilityImages.map((image, index) => (
                      <div
                        key={index}
                        className={`h-16 bg-black/40 border ${selectedImage === image.full ? "border-red-600" : "border-red-900/20"} rounded-md flex items-center justify-center cursor-pointer overflow-hidden`}
              ...
              <div className="rounded-lg border border-red-900/30 bg-black/60 shadow-md backdrop-blur-sm overflow-hidden hover:border-red-600/50 transition-all duration-300">
                ...
                <div className="p-4">
                  <h3 className="text-sm font-bold text-white mb-2">Location & Contact</h3>
                  <div className="h-0.5 w-8 bg-gradient-to-r from-red-600 to-red-400 rounded-full mb-3"></div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-300">4150 Washington Road, Suite 4</p>
                        <p className="text-xs text-gray-300">Evans, GA 30809</p>
                      </div>
                    </div>

                    <div className="flex items-start">
                      <Phone className="h-4 w-4 text-red-500 mt-0.5 mr-2 flex-shrink-0" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <Clock className="h-4 w-4 text-red-500 mt-0.5 mr-2 flex-shrink-0" />
                      <div>
                        <p className="text-xs text-white font-medium">Hours:</p>
                        <div className="text-xs text-gray-300 space-y-0.5">
                          {operatingHours.slice(0, 3).map((item, index) => (
                          ...
                          {operatingHours.length > 3 && (
                            <Link href="#hours" className="text-red-400 hover:text-red-300 flex items-center group">
                              View all hours
                ...
                >
                  <div className="flex items-start">
                    <div className="bg-red-900/20 p-2 rounded-full mr-3 flex-shrink-0">
                      <div className="bg-red-900/40 p-1 rounded-full text-red-400 flex items-center justify-center w-6 h-6">
                        {review.name.charAt(0)}
                      </div>
                    </div>
                    <div>
                      <h3 className="text-sm font-bold text-white mb-1">{review.name}</h3>
      ...
      <section className="py-6 relative" id="communities">
        <div className="absolute inset-0 bg-[url('/pattern-overlay.png')] opacity-2 mix-blend-overlay"></div>
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            {communitiesServed.map((community, index) => (
              <div
                key={index}
                className="rounded-lg border border-red-900/30 bg-black/60 shadow-md backdrop-blur-sm p-3 text-center hover:border-red-600/50 transition-all duration-300"
              >
                <div className="bg-red-900/20 p-2 rounded-full mb-2 mx-auto w-10 h-10 flex items-center justify-center">
      ...
      {/* Hours Section */}
      <section className="py-6 relative" id="hours">
        <div className="absolute inset-0 bg-[url('/pattern-overlay.png')] opacity-2 mix-blend-overlay"></div>
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-xl font-bold text-white mb-4 relative inline-block">
            Business Hours
          ...
          <div className="rounded-lg border border-red-900/30 bg-black/60 shadow-md backdrop-blur-sm p-4 hover:border-red-600/50 transition-all duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {operatingHours.map((item, index) => (
                <div key={index} className="flex justify-between border-b border-red-900/20 py-2 last:border-0">
                  <span className="text-sm font-medium text-white">{item.day}</span>
                  <span className="text-sm text-gray-300">{item.hours}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-6 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="rounded-lg border border-red-900/30 bg-black/60 shadow-md backdrop-blur-sm p-6 hover:border-red-600/50 transition-all duration-300">
            <p className="text-sm text-gray-300 mb-4">
              ...
              develop leadership skills, and embrace personal growth.
            </p>

            <p className="text-sm text-gray-300 mb-4">
              Our focus goes beyond mastering punches and kicks; we're dedicated to fostering an environment where
              everyone can thrive and evolve. Martial arts is far more than what you see in movies. It's a journey that
              instills discipline, respect, and perseverance—qualities that benefit every aspect of life.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="rounded-lg border border-red-900/30 bg-black/40 p-4 hover:border-red-600/50 transition-all duration-300">
                <h3 className="text-sm font-medium text-white mb-2 flex items-center">
                  <div className="bg-red-900/20 p-1 rounded-full mr-2">
              ...
              <div className="rounded-lg border border-red-900/30 bg-black/40 p-4 hover:border-red-600/50 transition-all duration-300">
                ...
                <p className="text-xs text-gray-300">
                  ...
                  getting fit; it's about joining a community committed to self-improvement. Our dojo offers a holistic
                  approach to wellness, combining physical fitness with mental clarity.
                </p>
              </div>
            </div>
          </div>
